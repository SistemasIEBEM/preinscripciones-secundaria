<%-- 
    Document   : folio_preinscribirDir
    Created on : 12/01/2017, 01:49:35 PM
    Author     : Registro
--%>
...
<html>
    <%
        ...
        String Ct_municipio = request.getAttribute("Ct_municipio") != null ? (String) request.getAttribute("Ct_municipio") : "";
        String Ct_turno = request.getAttribute("turno") != null ? (String) request.getAttribute("turno") : "";
                        ...
                        <center>
                            ...
                            <div class="col-lg-12">
                                <div class="col-md-6 col-md-offset-3">
                                    <img src="images/regresar.png" onclick="location.href = 'preinscribirDir.jsp';"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <img src="images/regresar.png" onclick="location.href = 'menudir.jsp';"/>
                                </div>
                            </div>
                            </div>
                            <!--</div>-->
