<%-- 
    Document   : consultaorigen
    Created on : 08-feb-2017, 9:32:43
    Author     : David Costet
--%>
...
<html>
    ...
    <head>
        ...
        <script src="<%=context%>/js/funciones/origen.js"></script>
    ...
    <body onload="nobackbutton();">
        <form action="<%=context%>/lugares" method="post" >
            <!-- Header -->
            ...
            <div class="container">
                ...
                <div class="login form-container" id="InputText">
                    ...
                    <center>
                        <input type="text"  placeholder="EJEMPLO: 17DJN0001J" name="ct" id="ct" onchange="muestraCT()" style="text-transform:uppercase;">
                    </center>
                    <br>
                </div>
